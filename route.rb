=begin
 ласс Route (ћаршрут):
+ »меет начальную и конечную станцию, а также список промежуточных станций. Ќачальна€ и конечна€ станции указываютсс€ при создании маршрута, а промежуточные могут добавл€тьс€ между ними.
+ ћожет добавл€ть промежуточную станцию в список
+ ћожет удал€ть промежуточную станцию из списка
+ ћожет выводить список всех станций по-пор€дку от начальной до конечной
=end
